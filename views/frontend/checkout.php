...
{  
   ...
   if($order->save())
   {
      foreach($listcart as $cart)
      {
         ...
         $orderdetail->price_id = $cart['price'];
         $orderdetail->qty_id = $cart['qty'];
         $orderdetail->amount_id = $cart['qty'] * $cart['price'];
         $orderdetail->save();
      }
      unset($_SESSION['cart']);
         ...
         <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb py-2 my-0">
               <li class="breadcrumb-item">
                  <a class="text-main" href="http://localhost/VuongTheTinh_2122110036/">Trang chủ</a>
               </li>
         ...
         <div class="row">
            <div class="col-md-6">
               ...
               <div class="mb-3">
                  ...
                  class="form-control" placeholder="Nhập email readonly">
               </div>
               <div class="card-body">
                     <div class="mb-3">
                        <label for="address">Địa chỉ</label>
                        <input type="text" name="address" value="<?=$customer->address;?>" id="address" id="address" 
