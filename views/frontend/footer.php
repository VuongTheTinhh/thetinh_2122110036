<section class="hdl-footer pb-4">
      <div class="container">
         <div class="row">
            <div class="col-md-4 pt-4">
               ...
               <p class="pt-1">
                  Điện thoại: 0999 999 999(call, zalo) - Email: thetinhsoft@gmail.com
               </p>
               <h3 class="widgettilte">MẠNG XÃ HỘI</h3>
               <div class="social my-3">
                  <div class="facebook-icon">
                     <a href="https://www.facebook.com/profile.php?id=100051224471419">
   ...
   <section class="dhl-copyright bg-dark py-3">
      <div class="container text-center text-white">
         Thiết kế bởi: Vương Thế Tình - Phone: 0999999999
      </div>
   </section>
</body>
</html>